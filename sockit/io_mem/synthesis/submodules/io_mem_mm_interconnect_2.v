...
`timescale 1 ps / 1 ps
module io_mem_mm_interconnect_2 (
	...
	io_mem_mm_interconnect_2_router router (
	...
	io_mem_mm_interconnect_2_router router_001 (
	...
	io_mem_mm_interconnect_2_router_002 router_002 (
	...
	io_mem_mm_interconnect_2_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                       //       clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	io_mem_mm_interconnect_2_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                       //       clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	io_mem_mm_interconnect_2_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                        //       clk.clk
		.reset               (io_mem_component_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	io_mem_mm_interconnect_2_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                        //       clk.clk
		.reset              (io_mem_component_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	io_mem_mm_interconnect_2_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	io_mem_mm_interconnect_2_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
