...
PORT (
	...
	conduit_gp_gp_in                  : in    std_logic_vector(31 downto 0)  := (others => 'X'); -- gp_in
	conduit_gp_gp_out                 : out   std_logic_vector(31 downto 0);                     -- gp_out
...
SIGNAL input_gp				: std_logic_vector(31 downto 0);
SIGNAL output_gp				: std_logic_vector(31 downto 0);
...
G3 : memory_io PORT MAP (
	...
	conduit_gp_gp_in                  => input_gp,                  -- conduit_gp.gp_in
	conduit_gp_gp_out                 => output_gp,                 --           .gp_out
